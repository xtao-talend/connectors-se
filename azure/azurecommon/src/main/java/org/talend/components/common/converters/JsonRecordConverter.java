...
public class JsonRecordConverter implements RecordConverter<JsonObject>, Serializable {
    ...
    public static JsonRecordConverter of(final RecordBuilderFactory factory, final JsonBuilderFactory jsonFactory) {
        return new JsonRecordConverter(factory, jsonFactory);
    }

    protected JsonRecordConverter(final RecordBuilderFactory factory, final JsonBuilderFactory jsonFactory) {
    ...
    public Type translateType(JsonValue value) {
        ...
        throw new UnsupportedOperationException("The data type " + value.getValueType() + " is not handled.");
    }
        ...
        schema.getEntries().stream().forEach(entry -> {
            ...
            case ARRAY:
                ...
                case BOOLEAN:
                    ...
                    break;
                default: {
                    throw new UnsupportedOperationException("Test Record doesn't contain any other data types");
                }
                }
                break;
            case STRING:
