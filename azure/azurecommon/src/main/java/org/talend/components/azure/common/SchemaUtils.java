...
public class SchemaUtils {
     ...
     */
    public static String getCorrectSchemaFieldName(String name, int nameIndex, Set<String> previousNames) {
    ...
    static String getUniqueName(String name, Set<String> previousNames) {
        int index = 0;
